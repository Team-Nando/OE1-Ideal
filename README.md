...
## Pre-Requisites
- Python (Anaconda) and Jupyter Notebook (comes with Anaconda). Note that this repository is meant to be used by individuals, which can get free access to Anaconda. For download links and more info: https://www.anaconda.com/download. Note that you must install the Anaconda that is compatible with your operating system (e.g., Windows, Mac). Also note that this repository is meant to be used by individuals, which can get free access to Anaconda.
